...
<body>
<div id="main">
    <div id="popup"><img src="static/logo3.png" /><img src="static/close-button.png" width="40" height="40" style="float: right; cursor: pointer;" id="closebutton" onclick="$(function() {$('#popup').fadeOut(400)});"/> <br />
...
<br />
    ...
    <div id="banner"><div><span id="logo"></span><span class="infobutton" onclick="$(function() {$('#popup').fadeIn(400)});">About</span></div></div>
